...
<head>
	...
	<?php endif; ?>
	<link rel="shortcut icon" href="<?php echo get_template_directory_uri(); ?>/images/myfav.png" />
 ...
 <div class="site-header">
                ...
                <div class="banner">
                    <div class="wrap clear">
                        ...
                        <a href="http://marinelookout.com/home/sign_up/"> Give your Exam Now </a>
                        </div>
                ...
                <div class="full-width header_btm">
                    <div class="wrap clear">
                        <a class="logo" href="http://marinelookout.com/"> <img src="<?php bloginfo('template_url'); ?>/images/logo.jpg" alt=""/> </a>
			...
			<li><a href="http://marinelookout.com/home/logout/" class="bLogout">Logout</a></li>
