...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Question Listing</div>
    </div>
 <!--For breadcrump-->    
...
<!--BEGIN CONTENT-->
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">Question Search Panel</h4>
                                        ...
                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL?>questionans/listing/0/0/">
					    <input type="hidden" name="is_show_all" id="is_show_all" value="0"/>
                                            <div class="row mbl">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="actions"><a href="<?php echo BACKEND_URL."questionans/add/";?>" class="btn btn-info btn-sm"><i class="fa fa-plus"></i>&nbsp;
                                           ...
                                           // error_reporting(0);
                                            ...
                                            <form name="frmPages" id="frmPages" action="<?php echo BACKEND_URL."questionans/listing/0/".$page;?>" method="post">
       ...
       <?php //pr($questionList);?>                                         <tr>
            ...
            <td>
                <?php  
                        if($questionList[$i]['question_type']=='Image'){
                ...
                <img src="<?php echo(isset($questionList[$i]['image']) && $questionList[$i]['image']!='' && file_exists(FILE_UPLOAD_ABSOLUTE_PATH."question/".$questionList[$i]['image']) ? BACKEND_IMAGE_PATH."question/".$questionList[$i]['image'] : BACKEND_IMAGE_PATH.'no_image.png');?>" alt="No Image" height="70" width="90"/></td>
                    <?php } ?>
                               ...
                               <td><?php echo stripslashes($questionList[$i]['title']);?></td>
                                <td><?php echo stripslashes($questionList[$i]['subject_title']);?></td>
