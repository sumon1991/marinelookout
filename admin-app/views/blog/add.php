        ...
        <div class="col-lg-12">
         <div style="background: transparent; border: 0; box-shadow: none !important;" class="pan mtl mbn responsive">
                            ...
                            <?php } ?>
                                        ...
                                        <div class="panel panel-yellow portlet box portlet-yellow">
                                            ...
                                            <div class="portlet-header">
                                                    <div class="caption">Add Blog</div>
                                                    <div class="tools">
                                            ...
                                            <div class="portlet-body panel-body pan">
                                                ...
                                                <form method="post" action="<?php echo BACKEND_URL;?>blog/add/" class="form-validate form-horizontal form-seperated " enctype="multipart/form-data" id="add_form">
                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group"><label for="title" class="col-md-3 control-label">Title<span class='require'>*</span></label>
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">                                                                
                                                                <textarea  name="description"   class="ckeditor form-control"><?php echo set_value('description');?></textarea>                                    
                                                            </div>
                                                        </div>
							...
							<div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input name="first_name" type="text" placeholder="Auther First Name" class="form-control required first_name" id="first_name" value="<?php echo set_value('first_name'); ?>"/>
                                                            </div>
                                                        </div>
							...
							<div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input name="last_name" type="text" placeholder="Auther Last Name" class="form-control required last_name" id="last_name" value="<?php echo set_value('last_name'); ?>"/>
                                                            </div>
                                                        </div>
							...
							<div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input name="qualification" type="text" placeholder="Auther Qualification" class="form-control required qualification" id="qualification" value="<?php echo set_value('qualification'); ?>"/>
                                                            </div>
                                                        </div>
							...
							<div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input name="designation" type="text" placeholder="Auther Designation" class="form-control required designation" id="designation" value="<?php echo set_value('designation'); ?>"/>
                                                            </div>
                                                        </div>
							...
							<div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input name="place" type="text" placeholder="Auther Place" class="form-control required place" id="place" value="<?php echo set_value('place'); ?>"/>
                                                            </div>
                                                        </div>
							...
							<div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input name="no_views" type="number" placeholder="No of views" class="form-control required no_views" id="no_views" value="<?php echo set_value('no_views'); ?>"/>
                                                            </div>
                                                        </div>
                                                        <!-- Mobile -->
								...
								<div class="row">
								    <div class="col-xs-6">
									<input type="file" name="bloger_image" id="bloger_image"  value=""/></div>
								</div>
							    </div>
							</div>
