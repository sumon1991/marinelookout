...
<!--BEGIN CONTENT-->
                                        ...
                                        <div class="table-container">
                                            ...
                                            <table class="table table-bordered table-advanced tablesorter tb-sticky-header">
                                                ...
                                                <tr>
                                                   ...
                                                   <th style="width: 10%;" data-toggle="true">Parent Category</th> 
        ...
        <?php
                        ...
                        <tr class="<?=($key%2==0?'even':'odd');?>">
                          <td><?php echo stripslashes($c['catData']['name']);?></td>
                          <td><?php echo stripslashes($c['parent_cat']);?></td>
                                       
                          <td>
                          <?php if($c['catData']['status']=='Active'){  echo '<label class="label label-green">'. 'Active';  } else {  echo '<label class="label label-red">'. 'Inactve'; } ?>
                          </td>
                        <td><a class="various3 previewLinkBtn changeStatus" href="<?php echo str_replace('{{ID}}',$c['catData']['id'],$edit_link);?>">
                        
                         <button type="button" class="btn btn-info btn-xs"><i class="fa fa-edit"></i>&nbsp;
                          Edit 
                          </button>
                        </a>
                         <a class="various3 previewLinkBtn changeStatus" href="<?php echo str_replace('{{ID}}',$c['catData']['id'],$del_link);?>">
