                            ...
                            <?php } ?>
                                        ...
                                        <div class="panel panel-yellow portlet box portlet-yellow">
                                            ...
                                            <div class="portlet-body panel-body pan">
                                                ...
                                                <form method="post" action="<?php echo BACKEND_URL;?>blog/category_edit/<?php echo $id;?>" class="form-validate form-horizontal form-seperated " enctype="multipart/form-data" id="add_form">
						                          <input type="hidden" name="action" value="process">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label for="status" class="col-md-3 control-label">Change Parent Category</label>
                                                            <div class="col-md-6">
                                                                <select data-required="true" name="parent_category" id="parent_category" class="form-control">
                                                                    ...
                                                                    <?php foreach ($categoryList as $key => $pc) { ?>
                                                                        <option value="<?php echo $pc['id']?>" <?= ($pc['id'] == $details[0]['parent_id'])?'selected':''; ?>><?php echo $pc['name'];?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                        </div>
