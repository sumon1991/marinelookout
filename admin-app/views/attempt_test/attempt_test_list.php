...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Total attempts Listing</div>
    </div>
    <!--For breadcrump-->    
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">Total attempts Search Panel</h4>

                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL."attempt_test";?>">
                                            <input type="hidden" name="is_show_all" id="is_show_all" value="0"/>
                                            <div class="row mbl">
                                                <div class="col-lg-6">
                                                    <div class="input-group input-group-sm mbs">
                                                    <div class="input-group datetimepicker-disable-time date"><input type="text" id="search_keyword" name="search_keyword" class="form-control" value="<?php echo $search_keyword; ?>"/><span class="input-group-addon"><i class="fa fa-calendar"></i></span></div>
                                            ...
                                            <table class="table table-bordered table-advanced tablesorter tb-sticky-header">
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="width: 5%;" data-toggle="true">Total Attempt</th> 
                                                </tr>
                                                </thead>
                                                <tbody id="listing">
                          <?php
...
<script>
      ...
      function searchValidation()
  {
   ...
   $('#btn_show_all').click(function(){
    $('#is_show_all').val(1);
    $('#perPageFrm').attr('action','<?php echo BACKEND_URL."attempt_test";?>');    
  });  
