...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Student Listing</div>
    </div>
    <!--For breadcrump-->    
...
<!--BEGIN CONTENT-->
                    ...
                    <div class="col-lg-14">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-14"><h4 class="box-heading">Student Search Panel</h4>

                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL."studentuser/index/0/0";?>">
                                            ...
                                            <div class="row mbl">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="actions"><a href="<?php echo BACKEND_URL."studentuser/add/";?>" class="btn btn-info btn-sm"><i class="fa fa-plus"></i>&nbsp;
                                                    Add Student</a>&nbsp;
                                                    </div>
                                                    </div>
                                                </div>
                                           ...
                                           // error_reporting(0);
                                            ...
                                            <form name="frmPages" id="frmPages" action="<?php echo BACKEND_URL."studentuser//0/".$page;?>" method="post">
                                            ...
                                            <table class="table table-bordered table-advanced tablesorter tb-sticky-header">
                                                <thead>
                                                <tr>
                                                 <th style="width: 10%;" data-toggle="true">Profile Image</th> 
                                                <th style="width: 10%;" data-toggle="true">First Name</th>
                                                <th style="width: 10%;" data-toggle="true">Last Name</th>
                                                <th style="width: 10%;" data-toggle="true">Email</th>
                                                <th style="width: 10%;" data-toggle="true">Mobile</th>
        ...
        <?php
        //pr($enquiryList);
                            if(isset($student_all) && is_array($student_all) && count($student_all)>0){
                            foreach($student_all as $key=>$student) {
                              
                             // echo (file_exists(FILE_UPLOAD_ABSOLUTE_PATH."student/".$student['image']))?'true':'false';
                            ?>
          
                        <tr class="<?=($key%2==0?'even':'odd');?>">
                          <td><img src="<?php echo(isset($student['image']) && $student['image']!='' && file_exists(FILE_UPLOAD_ABSOLUTE_PATH."student/".$student['image']) ? BACKEND_IMAGE_PATH."student/".$student['image'] : BACKEND_IMAGE_PATH.'no_image.png');?>" alt="No Image" height="70" width="90"/></td>
                          <td><?php echo stripslashes($student['firstname']);?></td>
                          <td><?php echo stripslashes($student['lastname']);?></td>
                          <td><?php echo stripslashes($student['email']);?></td>
                          <td><?php echo stripslashes($student['mobile']);?></td>
                          <td><?php echo stripslashes($student['added_on']);?></td>
                          <td><?php if($student['is_active']=='yes'){  echo '<label class="label label-green">'. 'Active';  } else {  echo '<label class="label label-red">'. 'Inactve'; } ?>
                                    </td>
                              <td>    <a class="various3 previewLinkBtn changeStatus" href="<?php echo $student['edit_link'];?>">
                              ...
                              <a class="various3 previewLinkBtn changeStatus" href="<?php echo  base_url().'examination/index/0/0/'.$student['id'];?>">
                                <span class="label label-sm label-warning">View Examination</span>
                              </a>
                               <a class="various3 previewLinkBtn changeStatus" href="<?php echo $student['delete_link'];?>">
                               <!-- <span class="btn btn-blue property_list property_list_preview">Edit</span>-->
...
<script>
    ...
    $('#is_show_all').val(1);
    $('#perPageFrm').attr('action','<?php echo BACKEND_URL."studentuser/index/0/0/";?>');    
  });
</script>
