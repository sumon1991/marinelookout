                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <select data-required="true" name="side" id="status" class="form-control required gender">
                                                                    ...
                                                                    <option value="right-sidebar1" <?=$advertisementdata[0]['alignment']=='right-sidebar1'?'selected':'';?>>Right Sidebar 1</option> 
                                                                    <option value="right-sidebar2" <?=$advertisementdata[0]['alignment']=='right-sidebar2'?'selected':'';?>>Right Sidebar 2</option>
