...
<!--BEGIN CONTENT-->
        ...
        <div class="col-lg-12">
         <div style="background: transparent; border: 0; box-shadow: none !important;" class="pan mtl mbn responsive">
                            ...
                            <img class="img-circle" style="border: 5px solid #fff; box-shadow: 0 2px 3px rgba(0,0,0,0.25);" src="<?php echo(isset($editoreditdata[0]['image']) && $editoreditdata[0]['image']!='' && file_exists(FILE_UPLOAD_ABSOLUTE_PATH."admin/".$editoreditdata[0]['image']) ? BACKEND_IMAGE_PATH."admin/".$editoreditdata[0]['image'] : BACKEND_IMAGE_PATH.'no_image.png');?>" height="140" width="140">
