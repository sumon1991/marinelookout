...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">NOTICE Listing</div>
    </div>
 <!--For breadcrump-->    
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <h4 class="box-heading">NOTICE Search Panel</h4>

                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL;?>notice/index/">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
						    ...
						    <th width="10%">Status</th>
                                                ...
                                                $editLink	= str_replace("{{ID}}",$noticeList[$i]['id'],$edit_link);
						$delLink	= str_replace("{{ID}}",$noticeList[$i]['id'],$delete_link);
                                                $class = 'class="even"';
                                                if($i%2==0)
                                                  $class = 'class="even"';
                                                else
                                                ...
                                                <tr <?php echo $class; ?>>
                                                    ...
                                                    <td><?php echo stripslashes($noticeList[$i]['subject']);?></td>
						    <td><?php echo date('d-m-Y',strtotime($noticeList[$i]['added_on']));?></td>         
						    <td align="center"><?php if($noticeList[$i]['status']=='active'){  echo '<label class="label label-green">'. 'Active';  }else{  echo '<label class="label label-red">'. 'Inactive'; } ?></label></td>                                              
