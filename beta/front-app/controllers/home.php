...
class Home extends MY_Controller{
 ...
 //        	die;
	if($this->input->post('hiddenaction')=='process')
		...
		$subject = 'Student Registration';
		$message = '<table><tr><td>Hello,</td></tr><tr><td>One new student has been registered</td></tr><tr><td>Student Details : </td></tr><tr><td>Student Name : '.$firstname.' '.$lastname.'</td></tr><tr><td>Student mobile : '.$mobile.'</td></tr></table>';
		$headers = 'From: '.$email . "\r\n".'X-Mailer: PHP/' . phpversion();
		$headers .= "MIME-Version: 1.0\r\n";
		$headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
		$is_send = mail($to, $subject, $message, $headers);
