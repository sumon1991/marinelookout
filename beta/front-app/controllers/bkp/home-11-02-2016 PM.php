...
class Home extends MY_Controller{
	...
	if($this->input->post('action')=='process')
	    ...
	    $this->form_validation->set_rules('indos', 'Indos', 'trim|required');
		...
		$message = '<table><tr><td>Hello,</td></tr><tr><td>'.$firstname.' '.$lastname.'</td></tr><tr><td>Please click <a href="'.FRONTEND_URL.'home/activate/'.$random_string.'" target="_blank">here</a> to activate your account</td></tr></table>';
		...
		if($is_send == 1)
		{
		    $this->session->set_userdata('succmsg', "Your account is created successfully.Please check your mail to activate your account.");
		}
		else
		{
		    if($id != '')
		    ...
		    $this->session->set_userdata('errmsg', "Verification mail cannot be sent. Please Sign up with your correct email id.");
		}
	    }
	}
