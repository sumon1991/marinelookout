			...
			<div class="wrap clear">
				...
				<h2> Student Sign Up Form </h2> 	
				 <form action="<?php echo FRONTEND_URL.'home/sign_up/'?>" method="post" id="sign_in" name="sign_in" class="form-validate" enctype="multipart/form-data">
                                        ...
                                        <div class="full-width">
                                        <input type="text" id="indos" name="indos" class="form-control required indos" placeholder="Indos" required value="<?php echo set_value('indos'); ?>"/>
                                        </div> 
                                        <div class="full-width">
                                            <input type="email" id="email" name="email" class="form-control required email" placeholder="Email" required value="<?php echo set_value('email'); ?>"/>
                                        </div>
                                        <div class="full-width">
