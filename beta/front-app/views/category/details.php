                ...
                <?php
                    ...
                    if(isset($all_details['posts']) && is_array($all_details['posts']) && count($all_details['posts'])>0){
                        foreach($all_details['posts'] as $key=>$single_blog)
                        {
                            ...
                            $otherPart  = substr($mystring,0,500);
                ...
                ?>
                            <div class="blockpanel noborderbottom clear">
                                ...
                                <div class="details-post">
                                    ...
                                    <a href="<?php echo FRONTEND_URL.'category/'.$single_blog['category_id'].'/'.$single_blog['id']; ?>"><img class="details-post-image" src="<?php echo FRONTEND_IMAGES; ?>image1.jpg" alt="image" /></a>
                                    <?php } else { ?>
                                   <a href="<?php echo FRONTEND_URL.'category/'.$single_blog['category_id'].'/'.$single_blog['id']; ?>"> <img class="details-post-image" src="<?php echo FRONTEND_URL.'upload/blogpost/'.$single_blog['featured_image']; ?>" alt="image" /></a>
                                    <?php } ?>
                                    <p><?php echo strip_tags($otherPart, 'strong'); ?></p>
                                    <p class="rightShow"><a href="<?php echo FRONTEND_URL.'category/'.$single_blog['category_id'].'/'.$single_blog['id']; ?>"><font color="orange">Continue Reading "<?php echo $single_blog['post_title']; ?>"</font></a></p>
                                </div>
                            </div>
                <?php
                        }
