<div class="examList">
    <div class="wrap clear">
        ...
        <div class="examBot">
			...
			<h4 style="float: right;clear: none;margin: 0;   font-size:15px;"><a href="<?= FRONTEND_URL.'my_account/sample_question_ans/' ?>">Sample QA</a> | <a href="<?= FRONTEND_URL.'my_account/sample_question/' ?>">Question</a></h4>
            <table>
                <tr>
                    <th>SR NO.</th>
                    <th>DATE</th>
