				...
				<tr>
					...
					<td width="33%">
						...
						<?php if(count($subject_lists)>0){ ?>
						  ...
						  <option value="<?= $sl['subject_slug'] ?>" <?php if($this->input->get('s') == $sl['subject_slug']){ ?>selected <?php } ?> ><?= $sl['title'] ?></option>
						  <?php } ?>
						<?php } ?>
					</select></form></td>
					<td width="33%"></td>
				...
				<tr >
					<td colspan="3" style="">
						...
						<?php if(count($question_ans)>0){ ?>
						  ...
						  <?php } ?>
						<?php }else{ ?>
						<tr><td style="text-align:center;color: red"> -- No Record Found -- </td></tr>
						<?php } ?>
						</table>
					</td>
				</tr>
