	...
	public function insertIntoBlogTable($tableName,$insertArr)
	{
		...
		if($insertArr && is_array($insertArr))
		{
			...
			if(array_key_exists('popular_post', $insertArr)){
				$sql = 'INSERT INTO `ep_blog_posts` (`category_id`, `post_author`, `post_content`, `featured_image`, `post_title`, `post_slug`, `popular_post`) VALUES ("'.$insertArr['category_id'].'", "'.$insertArr['post_author'].'", "'.mysql_real_escape_string ($insertArr['post_content']).'", "'.$insertArr['featured_image'].'", "'.$insertArr['post_title'].'", "'.$insertArr['post_slug'].'", "'.$insertArr['popular_post'].'")';
			} else {
				$sql = 'INSERT INTO `ep_blog_posts` (`category_id`, `post_author`, `post_content`, `featured_image`, `post_title`, `post_slug`) VALUES ("'.$insertArr['category_id'].'", "'.$insertArr['post_author'].'", "'.mysql_real_escape_string ($insertArr['post_content']).'", "'.$insertArr['featured_image'].'", "'.$insertArr['post_title'].'", "'.$insertArr['post_slug'].'"';
			}
			// echo $sql;
			// die;
