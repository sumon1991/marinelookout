...
class Blogpost extends MY_Controller {
	...
	{		
		...
		$data['category_list'] 	= $this->model_basic->getValues_conditions('ep_blog_categories');
		$this->templatelayout->get_topbar();
		$this->templatelayout->get_leftmenu();
		$this->templatelayout->get_footer();
	...
	public function edit()
	{
		...
		$this->data['category_list'] 		= $this->model_basic->getValues_conditions('ep_blog_categories');
