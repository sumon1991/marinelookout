                ...
                <div id="table-action" class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">Question Search Panel</h4>
                                        ...
                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL."subject_list/listing_sub/0/0/".$subjectSlug[0]['subject_slug'];?>">
                                            <div class="row mbl">
                                                <div class="col-lg-6">
						    ...
						    <div class="col-lg-6">
						   <div class="tb-group-actions"><span>Choice Gruop</span>
						   <select class="table-group-action-input form-control input-inline input-small input-sm mlm" name="group" id="apply_action">
...
<script>
  ...
  $('#btn_show_all').click(function(){
    $('#is_show_all').val(1);
    $('#perPageFrm').attr('action','<?php echo BACKEND_URL."subject_list/listing_sub/0/0";?>');    
  });     
