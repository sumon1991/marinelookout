                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                ...
                                                                if($questionList[0]['question_type'] == 'Image')
                                                                {
                                                                    ...
                                                                    {
                                                                ?>
                                                                    <img src="<?php echo BACKEND_IMAGE_PATH.'question/'.stripslashes($questionList[0]['image']);?>" width='75' title="">
                                                                <?php
                                                                    }
                                                                    else
                                                                    {
                                                                ?>
                                                                    <img src="<?php echo FILE_UPLOAD_URL.'inactive_no_image.png';?>" width='75' title="No Image">
                                                                <?php
                                                                    }
                                                                }
                                                                ?>
                                                ...
                                                <div class="row question_<?php echo $k;?> question_div">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <textarea name="answer_sheet[]" id="answer_sheet<?php echo $k;?>" rows="6" class="form-control required" placeholder="Answer"><?php echo stripslashes($value['answer']);?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="radio" class="required isCorrect" value="<?php echo $k;?>" id="isCorrect<?php echo $k;?>" name="isCorrect" <?=$value['is_correct_answer']=='Yes'?'checked':'';?>/>
                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
