...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Blog Author Listing</div>
    </div>
    <!--For breadcrump-->    
...
<!--BEGIN CONTENT-->
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="table-container">
                                            ...
                                            <a href="<?php echo $add_link ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add Author</a>
        ...
        <?php
                            //pr($blogList);
                            if(isset($authorList) && is_array($authorList) && count($authorList)>0){
                                foreach($authorList as $key=>$c)
                                {
                        ...
                        <td>
                            <?php if($c['photo']!=''){ ?>
                            <img width='100' src='<?php echo FILE_UPLOAD_URL.'blog_author/'.stripslashes($c['photo']);?>'/>
                        <?php } ?>
                        </td>
