...
<!--BEGIN CONTENT-->
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                <a href="<?php echo base_url()."contentimages/create/" ?>" class="btn btn-primary"><i class="fa fa-plus"></i> New File Upload</a>
                                           ...
                                           // error_reporting(0);
                                            ...
                                            <table class="table table-bordered table-advanced tablesorter tb-sticky-header">
                                                ...
                                                <tr>
                                                   ...
                                                   <th style="width: 10%;" data-toggle="true">Link</th>
        ...
        //pr($enquiryList);
                        ...
                        <tr class="<?=($key%2==0?'even':'odd');?>">
                          <td><img src="<?php echo stripslashes($file['link']);?>" alt="No Image" height="70" width="90"></td>
                          <td><?php echo stripslashes($file['title']);?></td>
                          <td><?php echo stripslashes($file['link']);?></td>
                          <td>   
