                            ...
                            <?php } ?>
                                        ...
                                        <div class="panel panel-yellow portlet box portlet-yellow">
                                            ...
                                            <div class="portlet-body panel-body pan">
                                                ...
                                                <form method="post" action="<?php echo BACKEND_URL;?>contentimages/create/" class="form-validate form-horizontal form-seperated " enctype="multipart/form-data" id="add_form">
