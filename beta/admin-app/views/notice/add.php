...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Add New Notice Page</div>
    </div>
 <!--For breadcrump-->    
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="panel panel-yellow portlet box portlet-violet">
                                            ...
                                            <div class="portlet-header">
                                                    <div class="caption">Add New Notice page</div>
                                                    <div class="tools">
						...
						<input type="hidden" name="action" value="Process">
                                                    <div class="form-body">
                                                        <div class="form-group"><label for="inputcmstitle" class="col-md-3 control-label">Subject<span class='require'>*</span></label>
                                                            <div class="col-md-4">
                                                                <input name="subject" type="text" placeholder="Subject" class="form-control required subject" id="subject" value="<?php echo set_value('subject'); ?>"/>
