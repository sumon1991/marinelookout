...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Testimonial Listing</div>
    </div>
    <!--For breadcrump-->    
...
<!--BEGIN CONTENT-->
                    ...
                    <div class="col-lg-14">
                        ...
                        <div id="tableactionTabContent" class="tab-content">
                            <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <div class="col-lg-12"><h4 class="box-heading">Testimonial Search Panel</h4>

                                        <div class="table-container">
                                            <form name="perPageFrm" id="perPageFrm" method="post" action="<?php echo BACKEND_URL."testimonial/index/0/0";?>">
                                            ...
                                            <div class="row mbl">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="actions"><a href="<?php echo BACKEND_URL."testimonial/add/";?>" class="btn btn-info btn-sm"><i class="fa fa-plus"></i>&nbsp;
                                                    Add Testimonial</a>&nbsp;
                                                    </div>
                                                    </div>
                                                </div>
                                           ...
                                           // error_reporting(0);
                                            ...
                                            <form name="frmPages" id="frmPages" action="<?php echo BACKEND_URL."testimonial//0/".$page;?>" method="post">
        ...
        <?php
        //pr($enquiryList);
                            if(isset($testimonial_all) && is_array($testimonial_all) && count($testimonial_all)>0){
                            foreach($testimonial_all as $key=>$testimonial) {
                              
                             // echo (file_exists(FILE_UPLOAD_ABSOLUTE_PATH."student/".$student['image']))?'true':'false';
                            ?>
          
                        <tr class="<?=($key%2==0?'even':'odd');?>">
                          <td><img src="<?php echo(isset($testimonial['image']) && $testimonial['image']!='' && file_exists(FILE_UPLOAD_ABSOLUTE_PATH."testimonial/".$testimonial['image']) ? BACKEND_IMAGE_PATH."testimonial/".$testimonial['image'] : BACKEND_IMAGE_PATH.'no_image.png');?>" alt="No Image" height="70" width="90"/></td>
                          <td><?php echo stripslashes($testimonial['name']);?></td>
                          <td><?php echo stripslashes($testimonial['created_at']);?></td>
                          <td><?php if($testimonial['status']=='Active'){  echo '<label class="label label-green">'. 'Active';  } else {  echo '<label class="label label-red">'. 'Inactve'; } ?>
                                    </td>
                              <td>    <a class="various3 previewLinkBtn changeStatus" href="<?php echo $testimonial['edit_link'];?>">
                               ...
                               <a class="various3 previewLinkBtn changeStatus" href="<?php echo $testimonial['delete_link'];?>">
                               <!-- <span class="btn btn-blue property_list property_list_preview">Edit</span>-->
...
<script>
    ...
    $('#is_show_all').val(1);
    $('#perPageFrm').attr('action','<?php echo BACKEND_URL."testimonial/index/0/0/";?>');    
  });
</script>
