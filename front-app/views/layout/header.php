...
<script type="text/javascript" id="st_insights_js" src="http://w.sharethis.com/button/buttons.js?publisher=9bc75e1c-1647-4fe0-adba-3f794ee47dd4"></script>
<script type="text/javascript">stLight.options({publisher: "9bc75e1c-1647-4fe0-adba-3f794ee47dd4", doNotHash: false, doNotCopy: false, hashAddressBar: false});</script>
<script>
...
<link href="//cdn-images.mailchimp.c" rel="stylesheet" type="text/css">
<style type="text/css">
#mc_embed_signup{background:#f Helvetica,Arial,sans-serif; width:270px;}
            	...
            	<div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 720px; height: 340px; overflow: hidden; visibility: hidden;">
                    ...
                    <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 720px; height: 340px; overflow: hidden;">          
                        <div data-p="132.50" style="display: none;">
                            ...
                            <div data-u="caption" data-t="3" style="position: absolute; bottom: 0; left: 0px; width: 100%; height: 30px; background-color: rgba(235,81,0,0.5); font-size: 18px; color: #ffffff; line-height: 30px; text-align: center;">A PLATFORM FOR BUDDING AND ESTABLISHED MARINERS</div>
                        </div>
                         <div data-p="132.50" style="display: none;">
                            <img data-u="image" src="<?php echo FRONTEND_IMAGES; ?>m-banner-2.jpg" />
                            <div data-u="caption" data-t="3" style="position: absolute; bottom: 0; left: 0px; width: 100%; height: 30px; background-color: rgba(235,81,0,0.5); font-size: 18px; color: #ffffff; line-height: 30px; text-align: center;">FACILITATING YOU AT AND BEYOND SEA</div>
                        </div>
                        <div data-p="132.50" style="display: none;">
                            <img data-u="image" src="<?php echo FRONTEND_IMAGES; ?>m-banner-3.jpg" />
                            <div data-u="caption" data-t="3" style="position: absolute; bottom: 0; left: 0px; width: 100%; height: 30px; background-color: rgba(235,81,0,0.5); font-size: 18px; color: #ffffff; line-height: 30px; text-align: center;">A GATEWAY TO ALL YOUR MEO - EXAMS</div>
                        </div>
            ...
            <div class="bannerRight">
            	<ul>
                    ...
                    <li> <img src="<?php echo FRONTEND_URL.'images/passage-planning.jpg'; ?>" alt="image">
                         <span style="cursor:pointer;"><a href="<?php echo FRONTEND_URL.'passage-planning/'; ?>">PASSAGE PLANNING</a></span>
